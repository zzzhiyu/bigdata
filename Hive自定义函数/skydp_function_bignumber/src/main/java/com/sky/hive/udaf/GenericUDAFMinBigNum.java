...
@Description(
        name = "min_bignum", value = "_FUNC_(x) - Returns the sum of a set of string"
)

public class GenericUDAFMinBigNum extends AbstractGenericUDAFResolver {
    static final Log LOG = LogFactory.getLog(GenericUDAFMinBigNum.class.getName());
    ...
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
        ...
        return  new GenericUDAFMinBigNum.GenericUDAFMinString();
    }

    @UDFType(distinctLike=true)
    public static class GenericUDAFMinString extends GenericUDAFEvaluator {
        ...
        static class MinBigNumBuffer extends AbstractAggregationBuffer {
            Object o;
        }

        @Override
        public AggregationBuffer getNewAggregationBuffer() throws HiveException {
            return new MinBigNumBuffer();
        }

        @Override
        public void reset(AggregationBuffer agg) throws HiveException {
            MinBigNumBuffer myAgg = (MinBigNumBuffer) agg;
            myAgg.o = null;
        }

...
@Description(
        name = "divide_bignum",
        value = "Returns the divide value of string"
)

public class GenericUDFDivideBigNum extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        output.set(num1.divide(num2, 18, BigDecimal.ROUND_HALF_UP).toString());
        return output;
    }

...
public class ParseInputDataOfOpensea {
    ...
    private OpenseaFee parseOpenSeaData(InputData inputData) {
        ...
        Order buy = new Order(inputData.getAddress()[0], inputData.getAddress()[1], inputData.getAddress()[2],
                new BigDecimal(inputData.getUints()[0]), new BigDecimal(inputData.getUints()[1]),
                new BigDecimal(inputData.getUints()[2]), new BigDecimal(inputData.getUints()[3]),
        ...
        Order sell = new Order(inputData.getAddress()[7], inputData.getAddress()[8], inputData.getAddress()[9],
                new BigDecimal(inputData.getUints()[9]), new BigDecimal(inputData.getUints()[10]),
                new BigDecimal(inputData.getUints()[11]), new BigDecimal(inputData.getUints()[12]),
